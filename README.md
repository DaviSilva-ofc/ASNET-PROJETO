...
Controlar o estado e a localização dos equipamentos

Facilitar a comunicação entre empresa, técnicos e clientes
...
Registo de localização hierárquica

Agrupamento → Escola → Bloco → Sala → Equipamento

Solicitação e gestão de reparações
...
Model: Entidades e acesso à base de dados
...
Análise de reparações realizadas

Custos e ganhos da empresa

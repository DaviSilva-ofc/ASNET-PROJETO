      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full) {
            return `<a href="/Apps/Invoice/Preview">#${full['invoice_id']}</a>`;
          }
        },
        {
          ...
          render: function (data, type, full) {
            ...
            <div class="d-flex justify-content-start align-items-center">
              ...
              <div class="d-flex flex-column">
                <a href="/Pages/Profile/User" class="text-heading text-truncate"><span class="fw-medium">${name}</span></a>
        ...
        },
        {
          ...
          render: function () {
            return (
              ...
              '<a href="/Apps/Invoice/Preview" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light" data-bs-placement="top" title="Preview Invoice"><i class="icon-base ri ri-eye-line icon-22px"></i></a>' +
              '<div class="dropdown">' +

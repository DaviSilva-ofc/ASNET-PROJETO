      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            // Creates full output for row
            const rowOutput = `<a href="/Apps/Invoice/Preview"><span>#${invoiceId}</span></a>`;
            return rowOutput;
          }
        },
        {
          ...
          render: (data, type, full, meta) => {
            return `
              <div class="d-flex align-items-center justify-content-center">
                ...
                <a href="/Apps/Invoice/Preview" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-toggle="tooltip" title="Preview">

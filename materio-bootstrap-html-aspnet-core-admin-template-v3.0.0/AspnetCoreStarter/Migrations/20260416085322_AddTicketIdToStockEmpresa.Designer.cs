...
namespace AspnetCoreStarter.Migrations
{
    ...
    [Migration("20260416085322_AddTicketIdToStockEmpresa")]
    partial class AddTicketIdToStockEmpresa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.Departamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.Setor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.TechnicianActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("technician_activities");
                });
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.Sala", b =>
                {
                    ...
                    b.HasOne("AspnetCoreStarter.Models.Setor", "Setor")
                        .WithMany("Salas")
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.Setor", b =>
                {
                    b.HasOne("AspnetCoreStarter.Models.Departamento", "Departamento")
                        .WithMany("Setores")
            ...
            modelBuilder.Entity("AspnetCoreStarter.Models.StockEmpresa", b =>
                {
                    ...
                    b.HasOne("AspnetCoreStarter.Models.Diretor", "Director")
                        .WithMany()
                    ...
                    b.HasOne("AspnetCoreStarter.Models.Professor", "Professor")
                        .WithMany()
                    ...
                    b.HasOne("AspnetCoreStarter.Models.Ticket", "Ticket")
                        .WithMany()

...
const buildIconifyTask = function (cb) {
  ...
  const fs = require('fs');
  const directories = ['./wwwroot/vendor/fonts/iconify', './wwwroot/vendor/fonts'];
  ...
  const iconify = require('child_process').spawn('node', ['./wwwroot/vendor/fonts/iconify/iconify.js'], {
    cwd: __dirname
  });
